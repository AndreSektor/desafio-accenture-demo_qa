...
const base = Cypress.env('URL_BASE')
...
class ApiPage {
    ...
    createUser() { 
        userCredentials = {
            ...
            password: "Desafio@0001",
        };

        cy.request({
            method: 'POST',
            url: (base + '/Account/v1/User'),
            headers: {
            ...
            cy.log(`Usuário criado com sucesso! ${response.body.username}`);
    ...
    generateToken(){ 
        cy.request({
            method: 'POST',
            url: (base + '/Account/v1/GenerateToken'),
            headers: {
                accept: 'application/json',
                'Content-Type': 'application/json',
            },
            ...
            cy.log(`Token gerado com sucesso! ${response.body.token}`);
    ...
    validAuthentication(){
        cy.request({
            method: 'POST',
            url: (base + '/Account/v1/Authorized'),
            headers: {
                accept: 'application/json',
                'Content-Type': 'application/json',
            },
